...
/*   Updated: 2025/02/23 13:40:50 by sohamdan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (b->content < a->content && *closest_small < b->content)
	{
...
{
	if (a->content > b->content && *closest_big > a->content)
	{
